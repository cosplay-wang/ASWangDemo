...
public class TTSActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //默认的tts不支持中文，切效果不好 ，，，切换科大讯飞之类的中文。效果较好
            ...
            public void onInit(int status) {
                if (status == TextToSpeech.SUCCESS) {
                    ...
                    if (result != TextToSpeech.LANG_COUNTRY_AVAILABLE && result != TextToSpeech.LANG_AVAILABLE) {
                        Toast.makeText(TTSActivity.this, "暂不支持该语言", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
...
//                textToSpeech.speak("Fields of this type should be declared final because bindings only detect",TextToSpeech.QUEUE_ADD,null,"speach");
