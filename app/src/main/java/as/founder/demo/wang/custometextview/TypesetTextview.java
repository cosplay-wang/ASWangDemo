...
/**
 * Created by zhiwei.wang on 2016/6/22.
 */
public class TypesetTextview extends TextView{
    ...
    public TypesetTextview(Context context, AttributeSet set)
    {
        super(context,set);
        ...
        int textcolor = typedArray.getColor(R.styleable. CYTextView_textColor,000000);
